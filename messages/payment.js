const PaymentMessages = {
  ...
  CURRENCY_MISMATCH:
    'Transaction currency ({{txnCurrency}}) does not match one or more account currencies.', // CU01
  UNSUPPORTED_CURRENCY:
    'Unsupported currency: {{currency}}. Only NGN, USD, GBP, and GHS are supported.', // CU02
  INSUFFICIENT_FUNDS:
    'Insufficient funds in debit account {{debitId}}: has {{balance}} {{currency}}, needs {{amount}} more.', // AC01
